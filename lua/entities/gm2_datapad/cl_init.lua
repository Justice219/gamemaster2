...
function ENT:DrawTranslucent()
    ...
    if imgui.Entity3D2D(self, Vector(-15,6,0), Angle(0,90,0), 0.1) then
        ...
        local tbl = util.JSONToTable(self:GetDataTable())
        ...
        -- Main UI
        draw.RoundedBox(6, -185,-1, 250, 90, Color(36,33,33, 100))
        draw.SimpleText("Datapad", imgui.xFont("!Roboto@20"),-180, -0, Color(223,189,41)) 
        draw.SimpleText("Press E To View" .. "", imgui.xFont("!Roboto@20"),-180, 20, Color(255,255,255))  
...
net.Receive("GM2:Entities:Datapad:Open", function(len, ply)
    gm.client.data.main = net.ReadTable()
    PrintTable(gm.client.data.main)
